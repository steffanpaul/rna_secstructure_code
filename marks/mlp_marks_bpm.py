...
back = sys.argv[2] #the data type used reduced or bpm
...
#Open data from h5py
filename = '../../data_marks/%s/%s_%s.hdf5'%(exp, exp, back)
...
if SOMCALC:
  ...
  arrayspath = 'Arrays/%s_%s_%s.npy'%(exp, modelarch, back)
...
if WRITE:
    ...
    metricsline = '%s,%s,%s,%s,%s,%s,%s,%s,%s,%s'%(date, 'mlp', numhidden, trial, numtrain,
