...
for data in ['1','2']
	...
	call(['python', 'resbind_pkhp.py', data, '2', '--train', '--test', '--somcalc', '--somvis'])
	call(['python', 'resbind_pkhp.py', data, '2', '--transfer', '--train', '--test', '--somcalc', '--somvis'])

	#train on some pkhp
	call(['python', 'resbind_pkhp.py', data, '3', '--some', '--train', '--test', '--somcalc', '--somvis'])

	#train on all hp and then transfer to some pkhp
	call(['python', 'resbind_pkhp.py', data, '4', '--train', '--test', '--somcalc', '--somvis'])
	call(['python', 'resbind_pkhp.py', data, '4', '--some', '--transfser', '--train', '--test', '--somcalc', '--somvis'])