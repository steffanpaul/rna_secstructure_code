...
#Open data from h5py
filename = '%s/%s_full.hdf5'%(exp, exp)
...
print ('numbp:', numbp, 'seqlen:', seqlen)
...
if SOMVIS:
  ...
  if APC:
      ...
      sb.heatmap(C,xticklabels=SS, yticklabels=SS,vmin=0., vmax=None, cmap='viridis', linewidth=0.0)
  ...
  if norm:
      ...
      #C = C/np.max(C)
      plt.figure(figsize=(25,20))
      sb.heatmap(C,xticklabels=SS, yticklabels=SS,vmin=None, vmax=None, cmap='viridis', linewidth=0.0)
